...
const PRICE_TO_PLAN: Record<string, { planId: string; planName: string }> = {
  ...
  price_1U0ofsAMjM6aPwDa9Ids4IFF: { planId: 'website-build', planName: 'Website Build (Site-in-a-Day)' },
  price_1U0ofsAMjM6aPwDa2PJM0HBD: { planId: 'website-care', planName: 'Website Care & Hosting' },
};
